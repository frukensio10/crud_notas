...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-07-2020 a las 03:35:26
...
(3, 'Navarro P', 'Castro', 'Michelle', 30, 40),
(4, 'Casillas', 'Manrique', 'Manuel', 13, 17),
(6, 'Gomez', 'Pelayo', 'Roy', 16, 19),
(7, 'Feliz', 'Gonzalez', 'Manuel', 34, 50),
(8, 'Rodriguez', 'Matos', 'Antonieta', 30, 40),
(9, 'Suarez', 'Lewis', 'Jimena', 30, 40);
